...
class HuobiDM:
    ...
    # 全部撤单
    def cancel_all_contract_order(self, symbol, code):
        """
        symbol: BTC, ETH, ...
        """
...
if __name__ == '__main__':
    ...
    # with open(r'C:\Users\Administrator\Desktop\server\huobiKey.ini', 'r') as f:
    #     huobi_apikey = f.read().splitlines()
    #
    # ####  input your access_key and secret_key below:
    # ACCESS_KEY = huobi_apikey[0]
    # SECRET_KEY = huobi_apikey[1]
    #
    ...
    # pprint(dm.get_contract_info(contract_code="BTC190628"))
    ...
    # pprint(dm.get_contract_price_limit(contract_code='BTC190628'))
    ...
    # print(u' 获取行情深度数据 ')
    # tiker = dm.get_contract_depth(symbol='ETH_CQ', type='step0')
    # print(tiker['tick']['asks'][0], tiker['tick']['bids'][0])
    # print(tiker['tick']['asks'][1], tiker['tick']['bids'][1])
    ...
    # 部分成交已撤单的数量运算
    # print(u' 获取合约当前未成交委托 ')
    # pprint(dm.get_contract_open_orders(symbol='ETH'))
